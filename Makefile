...
SRC_TLS = src/tls/quic_tls.c $(SRC_CRYPTO_STREAM) $(SRC_CONN) src/packet/quic_transport_params.c
...
BIN_TESTS = $(BIN_TEST_PHASE1) $(BIN_TEST_PHASE2) $(BIN_TEST_PHASE3) $(BIN_TEST_PHASE4) $(BIN_TEST_PHASE6) $(BIN_TEST_PHASE7) $(BIN_TEST_PHASE8) $(BIN_TEST_PHASE9) $(BIN_TEST_PHASE10) $(BIN_TEST_PHASE11) $(BIN_TEST_PHASE12)


.PHONY: all test1 test2 test3 test4 test6 test7 test8 test9 test10 test11 test12 example-certs quic-server quic-client quic-demo topo-auto clean net

all: $(BIN_TEST_PHASE1) $(BIN_TEST_PHASE2) $(BIN_TEST_PHASE3) $(BIN_TEST_PHASE4) $(BIN_TEST_PHASE6) $(BIN_TEST_PHASE7) $(BIN_TEST_PHASE8) $(BIN_TEST_PHASE9) $(BIN_TEST_PHASE10) $(BIN_TEST_PHASE11) $(BIN_TEST_PHASE12) $(BIN_EXAMPLE_SERVER) $(BIN_EXAMPLE_CLIENT)
